...
import { asNode, setMaterialOutput, setMaterialPosition } from '../../../tsl/shared/nodeInterop.js'
const WORKGROUP_X = 8
const WORKGROUP_Y = 8
...
class WGSLFlowParticles {
  constructor(renderer, options) {
    ...
    Object.defineProperty(this, 'colorPrimaryNode', {
      enumerable: true,
      configurable: true,
      writable: true,
      value: uniform(new Color(0.95, 0.5, 0.2)),
    })
    Object.defineProperty(this, 'colorSecondaryNode', {
      enumerable: true,
      configurable: true,
      writable: true,
      value: uniform(new Color(0.4, 0.3, 0.95)),
    })
    Object.defineProperty(this, 'colorMixNode', {
      enumerable: true,
      configurable: true,
      writable: true,
      value: uniform(0),
    })
    Object.defineProperty(this, 'particleSaturationNode', {
      enumerable: true,
      configurable: true,
      writable: true,
      value: uniform(1),
  ...
  createMesh() {
    ...
    // User palette: gradient between secondary and primary using the existing seed.
    // colorMix=0 keeps the original procedural rainbow look untouched.
    const userPalette = mix(this.colorSecondaryNode, this.colorPrimaryNode, a)
    palette = mix(palette, userPalette, this.colorMixNode.clamp(0, 1))
    // Saturation: blend toward Rec.601 luminance. 1 = neutral, <1 desaturated, >1 boosted.
    const palLuma = palette.dot(vec3(0.299, 0.587, 0.114))
    palette = mix(vec3(palLuma, palLuma, palLuma), palette, this.particleSaturationNode)
